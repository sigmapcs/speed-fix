...
<nav class="left-menu" left-menu>
    ...
    <div class="left-menu-inner scroll-pane">
        <ul class="left-menu-list left-menu-list-root list-unstyled">
            ...
            <li>
                <a class="left-menu-link" href="documentation.html">
            ...
            <li class="left-menu-list-submenu">
                ...
                <ul class="left-menu-list list-unstyled">
                    ...
                    <li>
                        <a class="left-menu-link" href="ecommerce-cart-checkout.html">
                            Cart / Checkout
                        </a>
                    </li>
                </ul>
            ...
            <li class="left-menu-list-submenu">
                ...
                <ul class="left-menu-list list-unstyled">
                    ...
                    <li>
                        <a class="left-menu-link" href="forms-file-uploads.html">
                            File Uploads
                        </a>
                    </li>
                    <li>
            ...
            <li class="left-menu-list-submenu">
                ...
                <ul class="left-menu-list list-unstyled">
                    ...
                    <li>
                        <a class="left-menu-link" href="components-breadcrumbs.html">
                            Breadcrumbs
                        </a>
                    </li>
                    <li>
            ...
            <li class="left-menu-list-submenu">
                ...
                <ul class="left-menu-list list-unstyled">
                    ...
                    <li>
                        <a class="left-menu-link" href="charts-chartjs.html">
                            Chart.js
                        </a>
                    </li>
                    <li>
...
<div class="page-content-inner">
    ...
    <div class="dashboard-container">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 col-xs-12">
                <div class="widget widget-seven background-info" style="background-image: url({{ asset('assets/common/img/temp/photos/9.jpeg)') }}">
                    <div class="carousel-widget-2 carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <a href="javascript: void(0);" class="widget-body">
                    ...
                    <div class="widget-body clearfix">
                        <div class="conversation-block custom-scroll" style="height: 260px">
                            <div class="conversation-item">
                                <div class="s1">
                                    <a class="avatar" href="javascript:void(0);">
                                        <img src="{{ asset('assets/common/img/temp/avatars/3.jpg') }}" alt="Alternative text to the image" />
                                    </a>
                                </div>
                                <div class="s2">
                            ...
                            <div class="conversation-item you">
                                <div class="s1">
                                    <a class="avatar" href="javascript:void(0);">
                                        <img src="{{ asset('assets/common/img/temp/avatars/4.jpg') }}" alt="Alternative text to the image" />
                                    </a>
                                </div>
                                <div class="s2">
